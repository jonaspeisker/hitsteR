...
- Players draw cards turn by turn. The QR code is scanned by somebody else which opens the Spotify app and plays the track. If the card is placed correctly in the player's timeline, they can keep it.
